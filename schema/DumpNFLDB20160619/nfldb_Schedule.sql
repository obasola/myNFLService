...
CREATE TABLE `Schedule` (
  ...
  `gameDate` varchar(45) DEFAULT NULL,
  `gameLocation` varchar(45) DEFAULT NULL,
  ...
  KEY `fk_Schedule_Team1_idx` (`Team_id`),
  ...
  CONSTRAINT `fk_Schedule_Team1` FOREIGN KEY (`Team_id`) REFERENCES `Team` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
