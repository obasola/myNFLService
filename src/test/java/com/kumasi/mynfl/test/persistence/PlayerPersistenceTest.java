...
import com.kumasi.mynfl.mock.PlayerEntityMock;
...
/**
 * JUnit test case for Player persistence service
 * 
...
public class PlayerPersistenceTest 
{
	...
	public void test1() {
		...
		PlayerPersistence service = PersistenceServiceProvider.getService(PlayerPersistence.class);
	...
	public void test2() {
		...
		System.out.println("Test Player persistence : delete + load ..." );
		
		PlayerPersistence service = PersistenceServiceProvider.getService(PlayerPersistence.class);
		
		PlayerEntityMock mock = new PlayerEntityMock();
	...
	private void process(PlayerPersistence service, PlayerEntityMock mock, Integer id ) {
		System.out.println("----- "  );
		System.out.println(" . load : " );
		PlayerEntity entity = service.load( id );
		if ( entity != null ) {
			// Found 
